      ...
      <div className="w-full max-w-md space-y-6">
        ...
        <div className="rounded-2xl border border-slate-200/80 dark:border-neutral-800 bg-white/90 dark:bg-neutral-900/90 p-6 sm:p-8 shadow-2xl backdrop-blur-xl space-y-6 transition-colors">
          ...
          <form onSubmit={handleLoginSubmit} className="space-y-4">
            <div>
              <label className="block text-xs font-medium text-slate-700 dark:text-neutral-300 mb-1">Employee Code / Phone / Username</label>
            ...
            <div>
              <label className="block text-xs font-medium text-slate-700 dark:text-neutral-300 mb-1">Staff Password</label>
              <div className="relative">
                <input
                  type="password"
                  required
          ...
          <div className="pt-2 text-center border-t border-slate-100 dark:border-neutral-800">
            <Link href="/login" className="text-xs text-slate-500 dark:text-neutral-400 hover:text-amber-500 dark:hover:text-amber-400 font-medium">
