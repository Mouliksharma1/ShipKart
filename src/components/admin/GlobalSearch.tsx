    ...
    <div ref={searchRef} className="relative w-full max-w-md">
      <div className="relative">
        ...
        <input
          ...
          className="w-full pl-10 pr-10 py-2.5 bg-slate-50 border border-slate-200 rounded-xl text-sm focus:outline-hidden focus:ring-2 focus:ring-orange-500/20 focus:border-orange-500 focus:bg-white transition-all shadow-xs"
        />
        {loading && (
      ...
      {isOpen && (
        <div className="absolute top-full left-0 right-0 mt-2 bg-white rounded-2xl border border-slate-200 shadow-xl overflow-hidden z-50 max-h-96 overflow-y-auto">
          {results.length === 0 ? (
              ...
              {results.map((r, i) => (
                ...
                >
                  <div className="flex items-center space-x-3">
                    <div className="p-2 bg-slate-100 rounded-lg">{getCategoryIcon(r.category)}</div>
                    <div>
